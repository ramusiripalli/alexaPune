...
response.titleText = "Update For Pune Weather";


  weather1.find({search: 'Pune, Maharashtra', degreeType: 'C'}, function(err, result) {
    if(err) {
    ...
    response.redirectionUrl = "http://ramusiripalli.xyz";
    response.mainText = "Hello from weather. Todays weather in Pune is expected to be " + day0weather + " Degree Celsius "+ day0weather1 +". Tomorrows weather in Pune is Expected to be " + day1weather + " Degree Celsius "+ day1weather1 + ". Third day weather in Pune is expected to  be " + day2weather + " Degree Celsius "+ day2weather2 +" . Fourth day weather in Pune will be " + day3weather + " Degree Celsius "+ day3weather3 + ". Fifth day weather in Pune will be " + day4weather+ " Degree Celsius "+ day4weather4;
    res.json(response);
    }
